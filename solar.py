...
if __name__ == '__main__':
    ...
    print('south: ', end='')
    print(solar_gain.get_solar_gain(SOUTH, pi / 2, timemg.stringdate_to_datetime(datetimestring)))
    print('east: ', end='')
    print(solar_gain.get_solar_gain(EAST, pi / 2, timemg.stringdate_to_datetime(datetimestring)))
    print('west: ', end='')
    print(solar_gain.get_solar_gain(WEST, pi / 2, timemg.stringdate_to_datetime(datetimestring)))
    print('north: ', end='')
    print(solar_gain.get_solar_gain(NORTH, pi / 2, timemg.stringdate_to_datetime(datetimestring)))
    exposure_in_rad_angles = [-pi + 2 * pi / 100 * i for i in range(100)]

    datetimes = [timemg.epochtimems_to_datetime(dt) for dt in range(timemg.stringdate_to_epochtimems(datestring + ' 0:00:00'), timemg.stringdate_to_epochtimems(datestring + ' 23:59:00'), 1000 * 60)]
